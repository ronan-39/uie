...
class Small_UWCNN(nn.Module):
    ...
    def _init_layers(self):
        ...
        self.conv2d_dehaze7 = nn.Conv2d(51+48, 3, 3, 1, 1)
...
class Tiny_UWCNN(nn.Module):
    ...
    def _init_layers(self):
        ...
        self.conv2d_dehaze4 = nn.Conv2d(51, 3, 3, 1, 1)
...
class Micro_UWCNN(nn.Module):
    def __init__(self):
        super().__init__()
        self._init_layers()

    def _init_layers(self):
        self.conv2d_dehaze1 = nn.Conv2d(3, 8, 1, 1)
        self.dehaze1_relu = nn.ReLU(inplace=True)
        ...
        self.conv2d_dehaze4 = nn.Conv2d(27, 3, 1, 1)
